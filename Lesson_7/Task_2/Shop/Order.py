...
from Shop.discount_politycy import loyal_customer_policy

class Order():

    MAX_ORDER_ELEMENT = 4

    def __init__(self, first_name, last_name, products = None, discount_policy = None):
    ...
    def generate_order(cls):
        ...
        order = Order("Kinga", "Elert", product_list, loyal_customer_policy)
        return order
